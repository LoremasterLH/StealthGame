...
void AFPSCharacter::Tick(float DeltaTime)
{
	...
	{
		// Fix rotation for player arms.
		FRotator NewRot = CameraComponent->RelativeRotation;
		NewRot.Pitch = RemoteViewPitch / 255.f * 360.f;
...
// Checking for cheating / client errors.
...
void AFPSCharacter::GetLifetimeReplicatedProps(TArray< FLifetimeProperty > & OutLifetimeProps) const
{
	...
	//DOREPLIFETIME_CONDITION(AFPSCharacter, bIsCarryingObjective, COND_OwnerOnly);	// Gets set only on whoever is carrying the objective
}