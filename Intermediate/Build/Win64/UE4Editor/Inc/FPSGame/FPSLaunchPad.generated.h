...
#define StealthGame_Source_FPSGame_Public_FPSLaunchPad_h_14_PRIVATE_PROPERTY_OFFSET \
	...
	FORCEINLINE static uint32 __PPO__LaunchPad() { return STRUCT_OFFSET(AFPSLaunchPad, LaunchPad); } \
	FORCEINLINE static uint32 __PPO__HitBox() { return STRUCT_OFFSET(AFPSLaunchPad, HitBox); } \
	FORCEINLINE static uint32 __PPO__Plane() { return STRUCT_OFFSET(AFPSLaunchPad, Plane); } \
	FORCEINLINE static uint32 __PPO__SteppedOnEffect() { return STRUCT_OFFSET(AFPSLaunchPad, SteppedOnEffect); } \
	FORCEINLINE static uint32 __PPO__SteppedOnSound() { return STRUCT_OFFSET(AFPSLaunchPad, SteppedOnSound); }
