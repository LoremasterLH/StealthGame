...
#define StealthGame_Source_FPSGame_Public_FPSBlackHole_h_14_RPC_WRAPPERS \
 \
	DECLARE_FUNCTION(execOverlapBlackHole) \
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		P_THIS->OverlapBlackHole(Z_Param_OverlappedComp,Z_Param_OtherActor,Z_Param_OtherComp,Z_Param_OtherBodyIndex,Z_Param_bFromSweep,Z_Param_Out_SweepResult); \
		P_NATIVE_END; \
	}
...
#define StealthGame_Source_FPSGame_Public_FPSBlackHole_h_14_PRIVATE_PROPERTY_OFFSET \
	...
	FORCEINLINE static uint32 __PPO__BlackHole() { return STRUCT_OFFSET(AFPSBlackHole, BlackHole); } \
	FORCEINLINE static uint32 __PPO__BlackHoleRadius() { return STRUCT_OFFSET(AFPSBlackHole, BlackHoleRadius); }
